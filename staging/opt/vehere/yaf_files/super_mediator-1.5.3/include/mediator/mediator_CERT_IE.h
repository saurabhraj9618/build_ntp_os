...
static fbInfoElement_t yaf_info_elements[] = {
    ...
    FB_IE_INIT_FULL("sslCertificate", CERT_PEN, 296, FB_IE_VARLEN, NONE,
                    0, 0, FB_OCTET_ARRAY, NULL),
    FB_IE_INIT_FULL("sslCertificateMD5", CERT_PEN, 299, FB_IE_VARLEN, NONE,
                    0, 0, FB_OCTET_ARRAY, NULL),
    FB_IE_INIT_FULL("sslCertificateSHA1", CERT_PEN, 298, FB_IE_VARLEN, NONE,
                    0, 0, FB_OCTET_ARRAY, NULL),
    /* mysql IEs */
    ...
    FB_IE_INIT_FULL("nDPIL7SubProtocol", CERT_PEN, 301, 2,
                    FB_IE_F_ENDIAN | FB_IE_IDENTIFIER, 0, 0, FB_UINT_16, NULL),
    /* super mediator specific */
    FB_IE_INIT_FULL("dnsRName", CERT_PEN, 927, FB_IE_VARLEN, NONE,
                    0, 0, FB_STRING, NULL),
    FB_IE_INIT_FULL("dnsHitCount", CERT_PEN, 928, 2, FB_IE_F_ENDIAN,
                    0, 0, FB_UINT_16, NULL),
    FB_IE_INIT_FULL("observedDataTotalCount", CERT_PEN, 929, 8,
                    FB_IE_F_ENDIAN | FB_IE_TOTALCOUNTER, 0, 0, FB_UINT_64, NULL),
    FB_IE_INIT_FULL("observedData", CERT_PEN, 930, FB_IE_VARLEN, NONE,
                    0, 0, FB_OCTET_ARRAY, NULL),
    /* old SSL fields prior to YAF 2.3.0 */
    FB_IE_INIT("sslCertIssuerCountryName", CERT_PEN, 191, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertIssuerOrgName", CERT_PEN, 192, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertIssuerOrgUnitName", CERT_PEN, 193, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertIssuerZipCode", CERT_PEN, 194, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertIssuerState", CERT_PEN, 195, FB_IE_VARLEN, NONE),
    FB_IE_INIT_FULL("sslCertIssuerCommonName", CERT_PEN, 196, FB_IE_VARLEN,
                    NONE, 0, 0, FB_STRING, NULL),
    FB_IE_INIT("sslCertIssuerLocalityName", CERT_PEN, 197, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertIssuerStreetAddress", CERT_PEN, 198, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSubCountryName", CERT_PEN, 200, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSubOrgName", CERT_PEN, 201, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSubOrgUnitName", CERT_PEN, 202, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSubZipCode", CERT_PEN, 203, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSubState", CERT_PEN, 204, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSubCommonName", CERT_PEN, 205, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSubLocalityName", CERT_PEN, 206, FB_IE_VARLEN, NONE),
    FB_IE_INIT("sslCertSubStreetAddress", CERT_PEN, 207, FB_IE_VARLEN, NONE),
    FB_IE_NULL
};
