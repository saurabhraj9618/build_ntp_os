...
dnl
dnl Use of the super_mediator and related source code is subject to the terms
...
AC_DEFUN([AX_CHECK_LIBZ],[
    ...
    AC_DEFINE_UNQUOTED([SM_ENABLE_ZLIB], [$ENABLE_ZLIB],
