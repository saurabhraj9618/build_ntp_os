...
B<yaf> flow key hash and prints the flow records along with the hash
...
The ingressInterface is included because B<rwsilk2ipfix> exports the vlanId
...
provided to I<--out> or stdout by default.  This option is meant to
be used when using with B<yafMeta2Pcap>.
